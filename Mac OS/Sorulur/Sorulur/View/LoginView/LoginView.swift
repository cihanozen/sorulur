...
//        if let uiButton: NSButton = view as? NSButton {
//            uiButton.roundedButton(COLORS.BORDER_WHITE)
//        } else if let uiView: NSView = view as? NSView {
...
//        NSView.animate(withDuration: 0.0, animations: {
...
//        NSView.animator(withDuration: 0.8, delay: 0.6, animations: {
